...
import com.zl.vo_.session.action.FileAction;
import com.zl.vo_.session.action.GuessAction;
import com.zl.vo_.session.action.RTSAction;
import com.zl.vo_.session.action.RedPacketAction;
...
import com.zl.vo_.session.extension.CustomAttachParser;
import com.zl.vo_.session.extension.CustomAttachment;
import com.zl.vo_.session.extension.GuessAttachment;
import com.zl.vo_.session.extension.RTSAttachment;
import com.zl.vo_.session.extension.RedPacketAttachment;
...
import com.zl.vo_.session.viewholder.MsgViewHolderFile;
import com.zl.vo_.session.viewholder.MsgViewHolderGuess;
import com.zl.vo_.session.viewholder.MsgViewHolderOpenRedPacket;
import com.zl.vo_.session.viewholder.MsgViewHolderRTS;
import com.zl.vo_.session.viewholder.MsgViewHolderRedPacket;
import com.zl.vo_.session.viewholder.MsgViewHolderSnapChat;
import com.zl.vo_.session.viewholder.MsgViewHolderSticker;
import com.zl.vo_.session.viewholder.MsgViewHolderTip;
...
//            p2pCustomization.backgroundUri = "android.resource://com.zl.vo_/drawable/bk"
