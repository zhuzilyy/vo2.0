...
class NimSDKOptionConfig {
    ...
    private static StatusBarNotificationConfig loadStatusBarNotificationConfig() {
        ...
        config.notificationSmallIconId = com.zl.vo_.R.drawable.ic_stat_notify_msg;
        config.notificationColor = DemoCache.getContext().getResources().getColor(com.zl.vo_.R.color.color_blue_3a9efb);
        // 通知铃声的uri字符串
        config.notificationSound = "android.resource://com.zl.vo_/raw/msg";
